...
void main() {
  ...
  test('testing calculating properties by rating with big rating', () async {
    final useCase = CalculatePropertiesUseCase();
    const rating = RatingEntity(rating: 100000);
    ...
    expect(
      props,
      const MemoPropertiesEntity(
        wordsCount: maxWordsCountValue,
        time: minTimeValue,
        isRating: true,
        ratingEntity: RatingEntity(rating: 100000),
      ),
    );
  });
}
